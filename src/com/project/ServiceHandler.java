...
////                out.print("<br/>");
//        if (contextArr[1].equals("web")) {
//            if (!request.getParameter("t").equals(Queries.SESSION+"")) {
//                out.println("<h1>Invalid Access!</h1>");
//
//            } else {
//
...
//"            var globalSearchWithin = \"\";\n" +
//"            var advanceSearchSection = null;\n" +
//"        </script>\n" +
...
//                out.println(content);
//            }
//        } else if (contextArr.length == 3 && contextArr[1].equals("api")) {
...
//        } else if (method_name.equals("getJharkhandPolicManual")) {
//            data = new ServiceHelper().getJharkhandPolicManual();
...
//            JsonObject input = getRawData(request.getReader());
//            String id = input.get("data").getAsString();
//
//            data = new ServiceHelper().removeBookmark(id);
//        } else if (method_name.equals("setEmail")) {
//            JsonObject input = getRawData(request.getReader());
////            //System.out.println(input.toString());
//            String email = input.get("email").getAsString();
//            HashMap<String, String> userData = (HashMap<String, String>) new ServiceHelper().getUserDetails().getData();
////            String user_name = input.get("user_name").getAsString();
//            String user_name = userData.get("user_name");
//            String subject = "";
//            if(input.get("subject")!=null){
//             subject = input.get("subject").getAsString();
//            }
...
//            data = new ResponseMaster(content,200);
